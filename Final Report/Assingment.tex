...
\title{
	\normalfont\normalsize
	\textsc{University of Plymouth}\\ % Your university, school and/or department name(s)
...
\author{\LARGE Max Barker} % Your name

\date{}

\begin{document}

% Set-up Harvard referencing.
...
\lstinputlisting[
	caption=code Perl Script., % Caption above the listing
	label=lst:code, % Label for referencing this listing
...
\subsection{How many code will be output by the Listing \ref{lst:code} above?}

Aliquam arcu turpis, ultrices sed luctus ac, vehicula id metus. Morbi eu feugiat velit, et tempus augue. Proin ac mattis tortor. Donec tincidunt, ante rhoncus luctus semper, arcu lorem lobortis justo, nec convallis ante quam quis lectus. Aenean tincidunt sodales massa, et hendrerit tellus mattis ac. Sed non pretium nibh. Donec cursus maximus luctus. Vivamus lobortis eros et massa porta porttitor.

%------------------------------------------------

\subsection{Identify the regular expression in Listing \ref{lst:code} and explain how it relates to the anti-war sentiments found in the rest of the script.}
...
\bibliography{refs} % Prints all references.

\section*{Bibliography}
\addcontentsline{toc}{section}{Bibliography}

\nocite{*} % Cites all references.
\bibliography{biblio} % Prints all references.
...
\section{First}\label{appendix:A}
\subsection{One section}
\subsection{Another section}

\section{Second}\label{appendix:B}
\subsection{Yet another section}
